#!/bin/bash
# Phase 3: Hierarchical training with adaptive gamma scheduling
...
python train.py \
    ...
    --save_path ./outputs/hierarchical_adaptive \
    --log_dir ./logs/hierarchical_adaptive \
    --wandb_project HPCM-Phase3 \
    --wandb_name hierarchical_adaptive \
    --cuda
